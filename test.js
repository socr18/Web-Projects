<!-- Banner/Gallery -->
    ...
    <div class="banner">
        <div class="banner-img">
        	<img alt="" src="https://az480170.vo.msecnd.net/6faae9aa-6b4a-4e9e-9280-75cc14565cb8/img/prd/c859653a-d0de-4a45-903e-698d0b3a2e58/propertysearchheader.jpg" />
...
<div id="property-map" class="property-map"></div>
        ...
        <div class="search-filter">
            <div class="search-form">
                ...
                <form>
                    ...
                    <!--<input type="checkbox" name="forsalelease" value="For Lease,For Sale" onclick="SetFilterValue(this.value, 'sale-type', this.checked)"> For Sale or Lease<br/>-->
                    ...
                    <label class="legend"><img alt="" height="26" width="16" src="https://az480170.vo.msecnd.net/6faae9aa-6b4a-4e9e-9280-75cc14565cb8/img/prd/671ea335-571f-40e0-a44a-99dd739ab594/bluepin.png" /> For Sale</label>
                    <label class="legend"><img alt="" height="26" width="16" src="https://az480170.vo.msecnd.net/6faae9aa-6b4a-4e9e-9280-75cc14565cb8/img/prd/45f4dbc2-f9bc-4850-9f38-0d5fcbdd8c05/greenpin.png" /> For Lease</label>
                    <label class="legend"><img alt="" height="26" width="16" src="https://az480170.vo.msecnd.net/6faae9aa-6b4a-4e9e-9280-75cc14565cb8/img/prd/4817c28d-b473-429f-a45b-235fefb3920a/darkgreenpin.png" /> For Sale or Lease</label>
    ...
    <script title="Midland Atlantic Code">
        ...
        function SetFilters() {
            ...
            if (state != "" && state != null) {
                ...
                geocoder.geocode({ 'address': state, componentRestrictions: {country: 'US'} }, function (results, status) {
    ...
    <script title="Required Custom Functionality">
        ...
        function ResultsUpdate() {
            try {
                ...
                $('.property-search-wrap .property-search-img img').each(function() {
                    if ($(this).attr('src') == '') {
                        $(this).attr('src','https://az480170.vo.msecnd.net/6faae9aa-6b4a-4e9e-9280-75cc14565cb8/img/orig/24d97e87-c26f-4f8e-be79-9752f275818a/noimage_square.jpg');
                    }
                });

                $('.property-view .property-search-wrap:gt(9)').hide();

                $('.show-button').click(function() {
                    $('.property-view .property-search-wrap:gt(9)').show();
                    $('.show-button').hide();
                });
            }
            catch (e) {
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDSn84J20LozLBAHXZ3VJ814qrf-lEjqfY&callback=MainMidlandMap"></script>
        ...
        <div class="page-content mobile-page-padding">
                            ...
                            <div class="large-6 medium-6 columns">
                                <div class="property-search-wrap {{directoryEntry.state}} {{directoryEntry.property-type}} {{directoryEntry.sale-type}}">
                                    <div class="property-search-img">
                                        <a href="{{directoryEntry.pageurl}}" target="_blank"><img src="{{directoryEntry.imgsrc}}" alt="{{directoryEntry.title}}" /></a>
                                    </div>
                                    <div class="property-search-text">
                                        <div class="property-search-title">
                                            <a href="{{directoryEntry.pageurl}}" target="_blank">{{directoryEntry.title}}</a>
                                        </div>
                                        ...
                                        <div class="property-read-more">
                                            <a href="{{directoryEntry.pageurl}}" target="_blank">
