...
                $('.bxslider2').append('<li data-order="' + arr[i]['social-sort'] + '"> <a href="' + json[i]['page-url'] + '"><h2>' + arr[i]['client-name'] + '</h2><img src="' + json[i]['website-url'] + '" alt="' + json[i]['client-name'] + '" /></a></li>');
